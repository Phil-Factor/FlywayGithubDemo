...
[StartDate] [date] NOT NULL CONSTRAINT [DF__EmailAddr__Start__595B4002] DEFAULT (getdate()),
[EndDate] [date] NULL,
...
[publication_id] [dbo].[tid] NOT NULL,
[Publication_type] [nvarchar] (20) COLLATE Latin1_General_CI_AS NOT NULL CONSTRAINT [DF__editions__Public__7814D14C] DEFAULT ('book'),
[EditionDate] [datetime2] NOT NULL CONSTRAINT [DF__editions__Editio__7908F585] DEFAULT (getdate())
) ON [PRIMARY]
GO
...
[royalty] [int] NULL,
[ytd_sales] [int] NULL,
[PriceStartDate] [datetime2] NOT NULL CONSTRAINT [DF__prices__PriceSta__7BE56230] DEFAULT (getdate()),
...
GO
PRINT N'Creating primary key [PK__Publicat__66D9D2B30A603FC5] on [dbo].[Publication_Types]'
GO
ALTER TABLE [dbo].[Publication_Types] ADD CONSTRAINT [PK__Publicat__66D9D2B30A603FC5] PRIMARY KEY CLUSTERED  ([Publication_Type]) ON [PRIMARY]
GO
...
GO
-- Executing: migrate -> v1.1.9 (with callbacks)
-- ---------------------------------------------------------------------------------------

-- Source: .\migrations\V1.1.9__AddconditionalVersion.sql
-- -------------------------------------------------------
...
GO
-- Executing: migrate -> v1.1.11 (with callbacks)
-- ---------------------------------------------------------------------------------------

-- Source: .\migrations\V1.1.11__AddProcedureWithTest.sql
-- -------------------------------------------------------
...
GO
ALTER TABLE [people].[Phone] ADD CONSTRAINT [FK__Phone__TypeOfPho__436BFEE3] FOREIGN KEY ([TypeOfPhone]) REFERENCES [people].[PhoneType] ([TypeOfPhone])
GO
